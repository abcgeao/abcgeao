...
function dplayer1 () {
    window.dp1 = new DPlayer({
        ...
        screenshot: true,
        video: {
            url: 'videos/shipin.mp4',
            pic: 'pic.png',
            thumbnails: 'images/pic1.png'
        },
        subtitle: {
            url: 'https://moeplayer.b0.upaiyun.com/dplayer/hikarunara.tt'
        },
        danmaku: {
            id: '410415235',
...
function dplayer3 () {
    window.dp3 = new DPlayer({
        ...
        hotkey: true,
        preload: 'auto',
        logo: 'https://moeplayer.b0.upaiyun.com/dplayer/DPlayer.jpg',
        volume: 0.7,
        mutex: true,
        video: {
        ...
        danmaku: {
            ...
            token: 'tokendemo',
            maximum: 1000,
            addition: ['https://api.prprpr.me/dplayer/bilibili?aid=21489542'],
            user: 'DIYgod',
            bottom: '15%',
            unlimited: true
        },
